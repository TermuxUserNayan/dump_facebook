...
figlet Hamii | lolcat
"""
___banner___ = ("""d8888b. db    db .88b  d88. d8888b.  \033[1;97m[\033[1;94m+\033[1;97m] AUTHOR : Swapno Nayan
88  `8D 88    88 88'YbdP`88 88  `8D  \033[1;97m[\033[1;94m+\033[1;97m] PHONE : +8801581558142
88   88 88    88 88  88  88 88oodD'  \033[1;97m[\033[1;94m+\033[1;97m] GITHUB : TermuxUserNayan
88   88 88    88 88  88  88 88~~~    \033[1;97m[\033[1;94m+\033[1;97m] FACEBOOK : SN SwApno NAYAN 
88  .8D 88b  d88 88  88  88 88       \033[1;97m[\033[1;94m+\033[1;97m] TEAM :  AMI NIJEI
...
def ___login___():
    ...
    try:
        ...
        if ___token in ['open','Open']:
            ...
            os.system('xdg-open https://www.facebook.com/swapno.nayan')
            exit()
        else:
